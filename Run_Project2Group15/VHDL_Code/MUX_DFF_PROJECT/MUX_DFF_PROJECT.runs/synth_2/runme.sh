...
HD_PWD='C:/Users/94201/MUX_DFF_PROJECT/MUX_DFF_PROJECT.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log APUF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source APUF.tcl
