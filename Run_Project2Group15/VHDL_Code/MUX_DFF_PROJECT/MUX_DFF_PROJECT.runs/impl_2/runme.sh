...
HD_PWD='C:/Users/94201/MUX_DFF_PROJECT/MUX_DFF_PROJECT.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log APUF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source APUF.tcl -notrace
