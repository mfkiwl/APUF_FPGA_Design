...
HD_PWD='C:/Users/94201/XOR_APUF/XOR_APUF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XOR_APUF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XOR_APUF.tcl
